...
CREATE TABLE [dbo].[Favorite](
	...
	[Favorite_User_ID] [int] NOT NULL FOREIGN KEY ([Favorite_User_ID]) REFERENCES [User]([User_ID]) ON DELETE CASCADE, -- пользователь, который добавил объ€вление в избранное
	[Favorite_Advert_ID] [int] NOT NULL FOREIGN KEY ([Favorite_Advert_ID]) REFERENCES [Advert]([Advert_ID]) ON DELETE CASCADE, -- объ€вление занесенное пользователем в избранное
)
GO